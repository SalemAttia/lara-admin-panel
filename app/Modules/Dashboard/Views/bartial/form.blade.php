...
@section('formAction', formAction($action, 'admin.users', inputValue('id', $data)) )
@section('form')
    <!--begin::Portlet-->
    <div class="m-portlet">
...
@push('scripts')
<script src="{{asset('metronic/assets/demo/default/custom/components/forms/validation/form-controls.js')}}" type="text/javascript"></script>
