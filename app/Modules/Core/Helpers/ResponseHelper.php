 ...
 * @return string
 */
if(!function_exists('selectBoxOptionsBuilder')){
...
if(!function_exists('selectBoxOptionsBuilder_parent')){
...
if(!function_exists('startQueryLog')){
...
if(!function_exists('groupedSelectBoxArrayBuilder')){
    /**
...
if(!function_exists('groupedSelectBoxArrayBuilder_products')){
...
if(!function_exists('groupedSelectBoxArrayBuilder_brands')){
...
if(!function_exists('TransformToNotNull')){
...
if(!function_exists('UploadUsingBase64')){
...
if(!function_exists('UploadUsingMultiPart')){
...
if(!function_exists('GenerateTandaCode')){
