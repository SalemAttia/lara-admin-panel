...
var Dashboard = function() {
    ...
    var dailySales = function() {
        var chartData = {
            labels: [myid, "Label 2", "Label 3", "Label 4", "Label 5", "Label 6", "Label 7", "Label 8", "Label 9", "Label 10", "Label 11", "Label 12", "Label 13", "Label 14", "Label 15", "Label 16"],
            datasets: [{
                //label: 'Dataset 1',
    ...
    var revenueChange = function() {
        ...
        Morris.Donut({
            ...
            data: [
                {label: "Total", value: totalHcpCoverage},
                {label: "Visited", value: visitedHcpCoverage},
                {label: "un Visited", value: unvisitedHcpCoverage}
            ],
            colors: [
    ...
    //** Based on Morris plugin - http://morrisjs.github.io/morris.js/
    //top 10
    var revenueChangetop10 = function() {
        if ($('#m_chart_revenue_changetop10').length == 0) {
            return;
        }

        Morris.Donut({
            element: 'm_chart_revenue_changetop10',
            data: [
                {label: "Total", value: totalTop10},
                {label: "Visited", value: top10hcpvisited},
                {label: "un Visited", value: unvisitedHcptop10Coverage}
            ],
            colors: [
                mUtil.getColor('accent'),
                mUtil.getColor('brand'),
    ...
    //top 10
    var revenueChangetop5 = function() {
        if ($('#m_chart_revenue_changetop5').length == 0) {
            return;
        }

        Morris.Donut({
            element: 'm_chart_revenue_changetop5',
            data: [
                {label: "Total", value: totalTop5},
                {label: "Visited", value: top5hcpvisited},
                {label: "un Visited", value: unvisitedHcptop5Coverage}
            ],
            colors: [
                mUtil.getColor('accent'),
                mUtil.getColor('brand'),
    ...
    //top
    var revenueChangepharmacy = function() {
        if ($('#m_chart_revenue_changepharmacy').length == 0) {
            return;
        }

        Morris.Donut({
            element: 'm_chart_revenue_changepharmacy',
            data: [
                {label: "Total", value: totalPharmacy},
                {label: "Visited", value: visitedPharmacy},
                {label: "un Visited", value: unvisitedpharmacy}
            ],
            colors: [
                mUtil.getColor('accent'),
                mUtil.getColor('brand'),
    ...
    //** Based on Morris plugin - http://morrisjs.github.io/morris.js/
    var revenueChangehf = function() {
        if ($('#m_chart_revenue_changehf').length == 0) {
            return;
        }

        Morris.Donut({
            element: 'm_chart_revenue_changehf',
            data: [
                {label: "Rep Frequency", value: repFrequency},
                {label: "Frequency", value: 6}
            ],
            colors: [
                mUtil.getColor('brand'),
                mUtil.getColor('accent')
   ...
   //pharmacy
    var revenueChangehpharmacyf = function() {
        if ($('#m_chart_revenue_changehpharmacyf').length == 0) {
            return;
        }

        Morris.Donut({
            element: 'm_chart_revenue_changehpharmacyf',
            data: [
                {label: "Rep Frequency", value: pharmacyFrequency},
    ...
    //** Based on Morris plugin - http://morrisjs.github.io/morris.js/
    var revenueChangetop10f = function() {
        if ($('#m_chart_revenue_changehtopf').length == 0) {
            return;
        }

        Morris.Donut({
            element: 'm_chart_revenue_changehtopf',
            data: [
                {label: "Frequency", value: reptop10Frequency},
                {label: "OF", value: 3}
            ],
            colors: [
                mUtil.getColor('brand'),
    ...
    //** Based on Morris plugin - http://morrisjs.github.io/morris.js/
    var revenueChangetop5f = function() {
        if ($('#m_chart_revenue_changehtop5f').length == 0) {
            return;
        }

        Morris.Donut({
            element: 'm_chart_revenue_changehtop5f',
            data: [
                {label: "Frequency", value: reptop5Frequency},
                {label: "OF", value: 2}
            ],
            colors: [
                mUtil.getColor('brand'),
    ...
    return {
        ...
        init: function() {
            ...
            revenueChangetop5();
            revenueChangetop5f();
            revenueChangehpharmacyf();
            revenueChangepharmacy();
            trendsStats2();
            latestTrendsMap();
            revenueChange();
            revenueChange2();
